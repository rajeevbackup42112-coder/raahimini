export const sharedMessages: Record<string, [number, string]> = {
  ...
  SHARED_REQUEST_CONCURRENT_STATE_CHANGED: [409, "This shared-ride request changed while Raahi was saving it. Please try again."],
  SHARED_REQUEST_BUSY_RETRY: [409, "This shared-ride request is changing right now. Please try again."],
  TRAVEL_INTENT_RATE_LIMITED: [429, "You have started several travel requests recently. Please try again later."],
