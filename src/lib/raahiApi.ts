...
export interface RouteForLocation { route_id: string; route_code: string; from_location_name: string; to_location_name: string; direction_label: string; fare_per_seat: number; has_active_car: boolean; active_car_status: TripStatus | null; available_seats: number; }
