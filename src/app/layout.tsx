...
const description = 'Find shared local rides or explore verified-driver outstation travel with Raahi. Public ride transactions remain in a controlled pilot until launch clearance is complete.';
...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Raahi — Shared rides and outstation travel', description, url: '/', siteName: 'Raahi', locale: 'en_IN', type: 'website', images: [{ url: '/og-raahi.png', width: 1200, height: 630, alt: 'Raahi — controlled local mobility pilot' }] },
