...
export default function LocalOffersContent(){
  ...
  return <div className="page-shell space-y-5">
    <section className="hero-surface"><p className="text-[11px] font-bold uppercase tracking-[0.14em] text-amber-200">Local Offers</p><h1 className="mt-2 text-2xl font-extrabold text-white sm:text-3xl">Local businesses help keep Raahi free.</h1><p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/75">Raahi charges no platform fee to passengers or drivers. Clearly marked local promotions help support the service.</p></section>
