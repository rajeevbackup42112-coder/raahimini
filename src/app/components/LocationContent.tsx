...
import { MapPin, Car, Navigation, CheckCircle2, Loader2 } from 'lucide-react';
    ...
    <div className="max-w-screen-2xl mx-auto px-4 py-5 space-y-6 animate-fade-in">
      <div className="rounded-3xl border border-green-100 bg-gradient-to-br from-green-50 to-card p-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Choose where you are. Raahi will show the clearest live ride option first.
        </p>
        {selectedLoc && <p className="mt-3 text-xs font-semibold text-primary">Your current choice: {selectedLoc.name}</p>}
      </div>
