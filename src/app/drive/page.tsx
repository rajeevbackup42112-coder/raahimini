  ...
  return (
    <main className="min-h-screen bg-zinc-100 px-5 py-10 text-zinc-950">
      <div className="mx-auto max-w-2xl">
        <div className="flex items-center justify-between gap-4"><p className="text-sm font-medium uppercase tracking-[0.18em] text-zinc-500">Raahi Driver</p><div className="flex items-center gap-4"><Link href="/drive/trips" className="text-sm font-semibold text-zinc-600">Trips</Link><Link href="/drive/carpool" className="text-sm font-semibold text-zinc-600">Carpool</Link><Link href="/drive/outstation" className="text-sm font-semibold text-zinc-600">Outstation</Link><Link href="/drive/history" className="text-sm font-semibold text-zinc-600">History</Link></div></div>
