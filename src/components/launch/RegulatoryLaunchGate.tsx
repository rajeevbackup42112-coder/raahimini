  ...
  return <div className="fixed inset-0 z-[75] flex items-end justify-center bg-black/55 sm:items-center sm:p-4">
    <div className="w-full max-w-lg rounded-t-3xl bg-card p-5 card-shadow-md sm:rounded-3xl sm:p-6">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1"><p className="section-label">Controlled launch</p><h2 className="mt-1 text-xl font-extrabold">Ride requests are opening area by area</h2></div>
...
export function RegulatoryLaunchBanner() {
  ...
  return <div className="border-b border-amber-200 bg-amber-50 px-4 py-2 text-center text-[11px] font-semibold text-amber-900">Raahi is live and onboarding verified Drivers area by area. Ride requests will open as verified supply is ready.</div>;
}