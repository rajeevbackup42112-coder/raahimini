...
| V7 | Automatic Start Trip after manifest resolved + usable GPS, preserving canonical FIFO handoff | BUILT + LOCALLY VALIDATED | NOT REQUIRED | PASS | PENDING DEPLOY/LIVE |
